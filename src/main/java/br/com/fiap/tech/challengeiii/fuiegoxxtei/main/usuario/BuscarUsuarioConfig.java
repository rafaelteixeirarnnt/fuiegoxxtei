...
public class BuscarUsuarioConfig {
   ...
   public BuscaUsuarioUseCase buscaUsuarioUseCase(BuscarUsuarioGateway buscarUsuarioGateway, BuscarUsuarioRequestMapper buscarUsuarioRequestMapper){
      return new BuscaUsuarioUseCaseImpl(buscarUsuarioGateway, buscarUsuarioRequestMapper);
   }

   @Bean
   public BuscarUsuarioGateway usuarioBuscaGateway(UsuarioEntityRepository usuarioEntityRepository,
